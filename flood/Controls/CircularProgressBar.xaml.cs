...
namespace flood
{
    ...
    public partial class CircularProgressBar
    {
        ...
        public static readonly DependencyProperty IsLoadingProperty =
            DependencyProperty.Register("IsLoading", typeof(bool), typeof(CircularProgressBar), new UIPropertyMetadata(false, PropertyChangedCallback));

        private static void PropertyChangedCallback(DependencyObject dependencyObject, DependencyPropertyChangedEventArgs dependencyPropertyChangedEventArgs)
        {
            var obj = dependencyObject as CircularProgressBar;

            if ((bool) dependencyPropertyChangedEventArgs.NewValue)
            {
                obj.Start();
                obj.Viewbox.Visibility = Visibility.Visible;
            }

            else
            {
                obj.Stop();
                obj.Viewbox.Visibility = Visibility.Hidden;
            }
        }
